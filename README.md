...
| [FEATURE_GUIDE.md](./FEATURE_GUIDE.md) | Advanced subscriber-facing workflows (events, anomalies, catalogs) |
| [docs/internal/](./docs/internal/) | **Operator-only** — synthesis, lineage, admin surfaces (**omit from subscriber manuals**) |
